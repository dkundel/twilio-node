...
interface MonthlyListEachOptions extends ListEachOptions<MonthlyInstance> {
  /**
   * The category
   */
  category?: MonthlyCategory;
...
interface MonthlyListOptions extends ListOptions<MonthlyInstance> {
  /**
   * The category
   */
  category?: MonthlyCategory;
...
interface MonthlyListPageOptions extends PageOptions<MonthlyPage> {
  /**
   * The category
   */
  category?: MonthlyCategory;
...
interface MonthlyListInstance {
   ...
   */
  each(opts?: MonthlyListEachOptions): void;
  /**
   * Streams MonthlyInstance records from the API.
   *
   * This operation lazily loads records as efficiently as possible until the limit
   ...
   */
  each(callback: (item: MonthlyInstance, done: (err?: Error) => void) => void): any;
  /**
   ...
   */
  getPage(targetUrl: string): Promise<MonthlyPage>;
  /**
   * Retrieve a single target page of MonthlyInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  getPage(targetUrl: string, callback: (error: Error | null, items: MonthlyPage) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  list(opts?: MonthlyListOptions): Promise<MonthlyInstance[]>;
  /**
   * Lists MonthlyInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(opts: MonthlyListOptions, callback: (error: Error | null, items: MonthlyInstance[]) => any): void;
  /**
   * Lists MonthlyInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(callback: (error: Error | null, items: MonthlyInstance[]) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  page(opts?: MonthlyListPageOptions): Promise<MonthlyPage>;
  /**
   * Retrieve a single page of MonthlyInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(opts: MonthlyListPageOptions, callback: (error: Error | null, items: MonthlyPage) => any): void;
  /**
   * Retrieve a single page of MonthlyInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(callback: (error: Error | null, items: MonthlyPage) => any): void;
}
...
export {MonthlySolution, MonthlyListOptions, MonthlyList, MonthlyInstance, MonthlyListEachOptions, MonthlyCategory, MonthlyListInstance, MonthlyListPageOptions, MonthlyResource, MonthlyPayload, MonthlyPage}
