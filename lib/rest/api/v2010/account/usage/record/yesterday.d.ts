...
interface YesterdayListEachOptions extends ListEachOptions<YesterdayInstance> {
  /**
   * The category
   */
  category?: YesterdayCategory;
...
interface YesterdayListOptions extends ListOptions<YesterdayInstance> {
  /**
   * The category
   */
  category?: YesterdayCategory;
...
interface YesterdayListPageOptions extends PageOptions<YesterdayPage> {
  /**
   * The category
   */
  category?: YesterdayCategory;
...
interface YesterdayListInstance {
   ...
   */
  each(opts?: YesterdayListEachOptions): void;
  /**
   * Streams YesterdayInstance records from the API.
   *
   * This operation lazily loads records as efficiently as possible until the limit
   ...
   */
  each(callback: (item: YesterdayInstance, done: (err?: Error) => void) => void): any;
  /**
   ...
   */
  getPage(targetUrl: string): Promise<YesterdayPage>;
  /**
   * Retrieve a single target page of YesterdayInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  getPage(targetUrl: string, callback: (error: Error | null, items: YesterdayPage) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  list(opts?: YesterdayListOptions): Promise<YesterdayInstance[]>;
  /**
   * Lists YesterdayInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(opts: YesterdayListOptions, callback: (error: Error | null, items: YesterdayInstance[]) => any): void;
  /**
   * Lists YesterdayInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(callback: (error: Error | null, items: YesterdayInstance[]) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  page(opts?: YesterdayListPageOptions): Promise<YesterdayPage>;
  /**
   * Retrieve a single page of YesterdayInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(opts: YesterdayListPageOptions, callback: (error: Error | null, items: YesterdayPage) => any): void;
  /**
   * Retrieve a single page of YesterdayInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(callback: (error: Error | null, items: YesterdayPage) => any): void;
}
...
export {YesterdayListOptions, YesterdayInstance, YesterdayResource, YesterdayCategory, YesterdayPage, YesterdayListInstance, YesterdayPayload, YesterdaySolution, YesterdayListPageOptions, YesterdayList, YesterdayListEachOptions}
