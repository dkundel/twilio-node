...
interface AllTimeListEachOptions extends ListEachOptions<AllTimeInstance> {
  /**
   * The category
   */
  category?: AllTimeCategory;
...
interface AllTimeListOptions extends ListOptions<AllTimeInstance> {
  /**
   * The category
   */
  category?: AllTimeCategory;
...
interface AllTimeListPageOptions extends PageOptions<AllTimePage> {
  /**
   * The category
   */
  category?: AllTimeCategory;
...
interface AllTimeListInstance {
   ...
   */
  each(opts?: AllTimeListEachOptions): void;
  /**
   * Streams AllTimeInstance records from the API.
   *
   * This operation lazily loads records as efficiently as possible until the limit
   ...
   */
  each(callback: (item: AllTimeInstance, done: (err?: Error) => void) => void): any;
  /**
   ...
   */
  getPage(targetUrl: string): Promise<AllTimePage>;
  /**
   * Retrieve a single target page of AllTimeInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  getPage(targetUrl: string, callback: (error: Error | null, items: AllTimePage) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  list(opts?: AllTimeListOptions): Promise<AllTimeInstance[]>;
  /**
   * Lists AllTimeInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(opts: AllTimeListOptions, callback: (error: Error | null, items: AllTimeInstance[]) => any): void;
  /**
   * Lists AllTimeInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(callback: (error: Error | null, items: AllTimeInstance[]) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  page(opts?: AllTimeListPageOptions): Promise<AllTimePage>;
  /**
   * Retrieve a single page of AllTimeInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(opts: AllTimeListPageOptions, callback: (error: Error | null, items: AllTimePage) => any): void;
  /**
   * Retrieve a single page of AllTimeInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(callback: (error: Error | null, items: AllTimePage) => any): void;
}
...
export { AllTimeCategory, AllTimeInstance, AllTimeList, AllTimeListEachOptions, AllTimeListInstance, AllTimeListOptions, AllTimeListPageOptions, AllTimePage, AllTimePayload, AllTimeResource, AllTimeSolution }
