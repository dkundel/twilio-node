...
interface LastMonthListEachOptions extends ListEachOptions<LastMonthInstance> {
  /**
   * The category
   */
  category?: LastMonthCategory;
...
interface LastMonthListOptions extends ListOptions<LastMonthInstance> {
  /**
   * The category
   */
  category?: LastMonthCategory;
...
interface LastMonthListPageOptions extends PageOptions<LastMonthPage> {
  /**
   * The category
   */
  category?: LastMonthCategory;
...
interface LastMonthListInstance {
   ...
   */
  each(opts?: LastMonthListEachOptions): void;
  /**
   * Streams LastMonthInstance records from the API.
   *
   * This operation lazily loads records as efficiently as possible until the limit
   ...
   */
  each(callback: (item: LastMonthInstance, done: (err?: Error) => void) => void): any;
  /**
   ...
   */
  getPage(targetUrl: string): Promise<LastMonthPage>;
  /**
   * Retrieve a single target page of LastMonthInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  getPage(targetUrl: string, callback: (error: Error | null, items: LastMonthPage) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  list(opts?: LastMonthListOptions): Promise<LastMonthInstance[]>;
  /**
   * Lists LastMonthInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(opts: LastMonthListOptions, callback: (error: Error | null, items: LastMonthInstance[]) => any): void;
  /**
   * Lists LastMonthInstance records from the API as a list.
   *
   * If a function is passed as the first argument, it will be used as the callback function.
   ...
   * @param callback - Callback to handle processed record
   */
  list(callback: (error: Error | null, items: LastMonthInstance[]) => any): void;
  /**
   ...
   * @param opts - Options for request
   */
  page(opts?: LastMonthListPageOptions): Promise<LastMonthPage>;
  /**
   * Retrieve a single page of LastMonthInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(opts: LastMonthListPageOptions, callback: (error: Error | null, items: LastMonthPage) => any): void;
  /**
   * Retrieve a single page of LastMonthInstance records from the API.
   * Request is executed immediately
   *
   ...
   * @param callback - Callback to handle processed record
   */
  page(callback: (error: Error | null, items: LastMonthPage) => any): void;
}
...
export {LastMonthInstance, LastMonthListOptions, LastMonthListPageOptions, LastMonthListEachOptions, LastMonthPayload, LastMonthCategory, LastMonthSolution, LastMonthListInstance, LastMonthResource, LastMonthList, LastMonthPage}
