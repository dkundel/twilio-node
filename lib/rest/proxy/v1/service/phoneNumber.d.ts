...
interface PhoneNumberResource {
  ...
  account_sid: string;
  /**
   * A list of capabilities of this phone numnber.
   */
  capabilities: string;
  /**
   * The date that this Phone Number was created, given in ISO 8601 format.
   */
  date_created: Date;
  /**
  ...
  iso_country: string;
  /**
   * The phone number. Phone numbers are in E.164 format (e.g. +16175551212). SIP addresses are formatted as `name@company.com`. Client identifiers are formatted `client:name`.
   */
  phone_number: string;
  /**
